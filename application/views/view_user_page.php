    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('user_page');?>">
                    <i class="fas fa-fw fa-user-alt"></i>
                    <span>Data Users</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('user_pembayaran_page');?>">
                    <i class="fas fa-fw fa-user-alt"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $data['user']['username']; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?=base_url();?>logout_proses">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800">Selamat Datang, <?= $data['user']['level_name']; ?></h1>
                    <!-- Page Heading -->
                    ...
                    <div class="container">
                        ...
                        <form action="<?= base_url();?>Page_admin/upload_file" enctype="multipart/form-data"
                            ...
                            <div class="form-group mt-3">
                                <label for="upload_file">Masukan File Excel</label>
                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><a role="button" data-toggle="modal" class="fas fa-edit"
                                                data-target="#modal_edit_user<?= $user['id']?>"></a></td>
                                        <td class="text-center"><a
                                                onclick="return confirm('Apakah Anda Yakin Untuk Menghapus?')"
                                                href="<?=base_url();?>page_admin/delete_user/<?= $user['id']?>"
                                                class="fas fa-trash text-danger"></a></td>
                                    </tr>
                                    <!-- Modal Edit User-->
                                    <div class="modal fade" id="modal_edit_user<?= $user['id']?>" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Edit Data User
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= base_url();?>page_admin/edit_user" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="tanggal_lahir"
                                                                placeholder="Masukan Tanggal" name="tanggal_lahir"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="id_user_level">User Level</label>
                                                            <select class="form-control" name="id_user_level">
                                                                <option value="<?=$user['id_user_level']?>"></option>
                    ...
                    <div class="modal fade" id="modal_add_user" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= base_url();?>page_admin/tambah_user" method="POST">
                                        <div class="form-group">
                                            <label for="username">Username</label>
                                            <input type="text" class="form-control" id="username"
                                                placeholder="Masukan Username" name="username">
